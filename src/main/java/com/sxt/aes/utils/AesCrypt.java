...
public class AesCrypt {
    ...
    public static byte[] aesEncryptToBytes(String content, String encryptKey) throws Exception {
        ...
        /*
         * // AES/CBC/PKCS5Padding 算法模式为CBC可以增加偏移量，可增加加密算法强度。 String ivParameter =
         * "0392039203920300"; IvParameterSpec iv = new
         * IvParameterSpec(ivParameter.getBytes()); cipher.init(Cipher.ENCRYPT_MODE, new
         * SecretKeySpec(encryptKey.getBytes(), "AES"), iv);
         */
